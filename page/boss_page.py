...
class CustomerCenterPage(PageBrowser):
    ...
    # 商户基本信息
    merchant_name_en = Element(xpath='//label[contains(text(),"商户名称(English)")]/following-sibling::div[1]/div/input', describe='商户名称_en')
    merchant_name_zh = Element(xpath='//label[contains(text(),"商户名称(简体中文)")]/following-sibling::div[1]/div/input', describe='商户名称_zh')
    merchant_name_cb = Element(xpath='//label[contains(text(),"商户名称(ខ្មែរ)")]/following-sibling::div[1]/div/input', describe='商户名称_cb')
    merchant_style_person = Element(xpath='//label[contains(text(),"个体商户")]', describe='商户类型_个体商户')
    merchant_style_enterprise = Element(xpath='//label[contains(text(),"企业商户")]', describe='商户类型_企业商户')
    merchant_charge_name = Element(xpath='//label[contains(text(),"负责人姓名")]/following-sibling::div[1]/div/input', describe='负责人_姓名')
    merchant_certificate_type = Element(xpath='//label[contains(text(),"证件类型")]/following-sibling::div[1]/div/div/div/span', describe='证件类型')
    merchant_identity_card = Element(xpath='//li[contains(text(),"身份证")]', describe='身份证')
    merchant_passport = Element(xpath='//li[contains(text(),"护照")]', describe='护照')
    merchant_certificate_no = Element(xpath='//label[contains(text(),"证件号码")]/following-sibling::div[1]/div/input', describe='证件号码')
    merchant_certificate_photo = Element(xpath='//label[contains(text(),"证件照片")]/following-sibling::div[1]/div/div/div/input', describe='证件照片')
    merchant_certificate_country = Element(xpath='//label[contains(text(),"证件国籍")]/following-sibling::div[1]/div/div/div/span', describe='证件国籍')
    merchant_statue_open = Element(xpath='//label[contains(text(),"启用")]', describe='状态_启用')
    merchant_statue_close = Element(xpath='//label[contains(text(),"停用")]', describe='状态_停用')

    # 业务协议
    merchant_business_first_merchant = Element(xpath='//label[contains(text(),"关联一级商户")]/following-sibling::div[1]/div/div/div/span', describe='关联一级商户')
    merchant_business_li_list_4 = Element(xpath='//label[contains(text(),"关联一级商户")]/following-sibling::div[1]/div/div[2]/ul[2]/li', describe='关联一级商户_li_list_4', index=3)

    merchant_connect_name = Element(xpath='//label[contains(text(),"联系人")]/following-sibling::div[1]/div[1]/input', describe='联系人_名称')
    merchant_connect_surname = Element(xpath='//label[contains(text(),"联系人")]/following-sibling::div[1]/div[2]/input', describe='联系人_姓')
    merchant_connect_phoneNo = Element(xpath='//label[contains(text(),"联系电话")]/following-sibling::div[1]/div/input', describe='联系电话')
    merchant_contract_photo = Element(xpath='//label[contains(text(),"合同扫描件")]/following-sibling::div[1]/div/div/div/input', describe='合同扫描件')

    # 管理账号信息
    merchant_login_phoneNo = Element(xpath='//label[contains(text(),"登录手机号")]/following-sibling::div[1]/div/input', describe='登录手机号')
    merchant_email = Element(xpath='//label[contains(text(),"邮箱")]/following-sibling::div[1]/div/input', describe='邮箱')
    merchant_user_name = Element(xpath='//label[contains(text(),"用户名")]/following-sibling::div[1]/div/input', describe='用户名')
    merchant_password = Element(xpath='//label[contains(text(),"登录密码")]/following-sibling::div[1]/div/input', describe='登录密码')
    merchant_password_second = Element(xpath='//label[contains(text(),"确认密码")]/following-sibling::div[1]/div/input', describe='确认密码')
